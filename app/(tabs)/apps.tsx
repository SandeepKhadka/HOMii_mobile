                    ...
                    <Pressable
                      ...
                      onPress={() => {
                        if (Platform.OS === "android" && app.androidPackageName) {
                          Linking.openURL(
                            `intent:#Intent;package=${app.androidPackageName};action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;end`
                          ).catch(() => router.push(`/category/${section.categoryId}` as any));
                        } else if (app.deepLinkScheme) {
