...
import { View, Pressable, ImageBackground, ScrollView, Keyboard, Image, KeyboardAvoidingView, Platform, Dimensions } from "react-native";
  ...
  return (
    ...
    >
      <ScrollView
        ...
        contentContainerStyle={{ paddingBottom: insets.bottom + 32, backgroundColor: "#fff" }}
      >
        {/* Top hero */}
        <ImageBackground
        ...
        {/* Bottom card — minHeight ensures it covers the full screen, no grey gap */}
        <View style={{ minHeight: SCREEN_HEIGHT - 192, backgroundColor: "#fff" }} className="rounded-t-3xl -mt-8 px-8 pt-8 pb-4">
